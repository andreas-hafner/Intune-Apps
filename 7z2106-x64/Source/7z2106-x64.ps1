...
If ($Install) {
    ...
    Start-Process -NoNewWindow -FilePath "msiexec.exe" -ArgumentList " /i 7z2106-x64.msi /q" -Wait
...
ElseIf ( $UnInstall ) {
    ...
    #Your code goes here
    Start-Process -NoNewWindow -FilePath "msiexec.exe" -ArgumentList ' /x "{23170F69-40C1-2702-2106-000001000000}" /qn' -Wait 
