...
.SYNOPSIS
Install de-DE Language Pack over Intune, tested with Autopilot Pre-Provisioning process.
	
.DESCRIPTION
Install de-DE Language Pack over Intune, tested with Autopilot Pre-Provisioning process. Should work since 2004 / 20H1, tested for Pre-Provisioning with Windows 10 21H2.
...
Filename   : Win10-21H2-LanguagePack-de-DE.ps1
