...
If ($Install) {
    ...
    Start-Process -FilePath "setup.exe" -ArgumentList "/configure SAEC-DE-EN-x64.xml"  -Wait -WindowStyle Hidden -ErrorAction Stop
...
ElseIf ( $UnInstall ) {
    ...
    #Your code goes here
    Start-Process -FilePath "setup.exe" -ArgumentList "/configure M365-uninstall.xml"  -Wait -WindowStyle Hidden -ErrorAction Stop
